...
func regConstants() {
	for name, constant := range map[string]int{
		...
		"LineDashUnset":         int(excelize.LineDashUnset),
		"LineDashSolid":         int(excelize.LineDashSolid),
		"LineDashDot":           int(excelize.LineDashDot),
		"LineDashDash":          int(excelize.LineDashDash),
		"LineDashLgDash":        int(excelize.LineDashLgDash),
		"LineDashSashDot":       int(excelize.LineDashSashDot),
		"LineDashLgDashDot":     int(excelize.LineDashLgDashDot),
		"LineDashLgDashDotDot":  int(excelize.LineDashLgDashDotDot),
		"LineDashSysDash":       int(excelize.LineDashSysDash),
		"LineDashSysDot":        int(excelize.LineDashSysDot),
		"LineDashSysDashDot":    int(excelize.LineDashSysDashDot),
		"LineDashSysDashDotDot": int(excelize.LineDashSysDashDotDot),
		// LineType enumeration
		"LineUnset":     int(excelize.LineUnset),
		"LineSolid":     int(excelize.LineSolid),
		"LineNone":      int(excelize.LineNone),
		"LineAutomatic": int(excelize.LineAutomatic),
